...
<html>
    ...
    <h1>Video</h1>
    <h1>Overview</h1>
        <p>This purpose of this project was to develop my first mobile application development experience for an Android device using Android Studios. I utilized technologies that I learned through my major at GCU such as Java, PHP, and MySQL. This application will allow employees to simply view and manage their work schedule from a smartphone or tablet device.  </p>
