...
public class ViewMessageWallAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(ViewMessageWallAdmin.this);
                ...
                RequestQueue queue = Volley.newRequestQueue(ViewMessageWallAdmin.this);
