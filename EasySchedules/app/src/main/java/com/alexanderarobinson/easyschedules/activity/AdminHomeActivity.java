            ...
            public boolean onNavigationItemSelected(@NonNull final MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.createSchedule:
                        final Intent intent = new Intent(AdminHomeActivity.this, CreateScheduleActivity.class);
                    ...
                    case R.id.home:
                        return true;
                    case R.id.connect:
                        final Intent intent1 = new Intent(AdminHomeActivity.this, ConnectActivity.class);
