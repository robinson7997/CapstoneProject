...
//Create schedule Http request using volley
public class CreateScheduleRequest extends StringRequest {
    ...
    public CreateScheduleRequest(String user_id, String company_id, String month, String day, String start_time, String end_time, Response.Listener<String> listener){
